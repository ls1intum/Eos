...
public final class ThrowableInfo {
    ...
    private ThrowableInfo(Class<? extends Throwable> type, String message, Throwable cause, StackTraceElement[] stackTrace, Throwable[] suppressed,
    ...
    public static ThrowableInfo of(Class<? extends Throwable> type, String message, Throwable cause, StackTraceElement[] stackTrace, Throwable[] suppressed,
            Map<String, Object> additionalProperties) {
