...
public interface UnifiedInvocationInterceptor extends InvocationInterceptor {
    ...
    @Override
    default <T> T interceptTestClassConstructor(Invocation<T> invocation, ReflectiveInvocationContext<Constructor<T>> invocationContext, ExtensionContext extensionContext)
            throws Throwable {
    ...
    @Override
    default void interceptTestTemplateMethod(Invocation<Void> invocation, ReflectiveInvocationContext<Method> invocationContext, ExtensionContext extensionContext)
            throws Throwable {
        interceptGenericInvocation(invocation, extensionContext, Optional.of(invocationContext));
    }
