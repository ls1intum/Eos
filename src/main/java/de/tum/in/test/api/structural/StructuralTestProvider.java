...
public abstract class StructuralTestProvider {
    ...
    protected static boolean checkModifiers(String[] observedModifiers, JSONArray expectedModifiers) {
        ...
        boolean hasAllNecessaryModifiers = modifierSpecifications.stream().filter(ModifierSpecification::isRequired).map(ModifierSpecification::getModifier)
                .allMatch(observedModifiersSet::contains);
